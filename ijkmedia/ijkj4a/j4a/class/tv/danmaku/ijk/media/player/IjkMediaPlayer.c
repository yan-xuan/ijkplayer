...
jboolean J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onNotifySaveImage(JNIEnv *env, jobject weakThiz, const char* filePath_cstr__, jint time)
{
    ...
    (*env)->CallStaticVoidMethod(env, class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.id, class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.method_onNotifySaveImage, weakThiz, filePath, time);
